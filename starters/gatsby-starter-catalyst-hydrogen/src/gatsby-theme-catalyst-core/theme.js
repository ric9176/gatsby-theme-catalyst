...
export default {
  ...
  sizes: {
    ...
    logoWidthXS: "100px", // Logo width on extra small screens, up to 480px
    logoWidthS: "150px", // Logo width on small screens, 480px - 768px
    logoWidthM: "150px", // Logo width on medium screens, 768px - 1024px
    logoWidthL: "200px", // Logo width on large screens, 1024px - 1440px
    logoWidthXL: "200px", // Logo width on extra large screens, above 1440px
    logoHeightXS: "100px", // Logo height on extra small screens, up to 480px
    logoHeightS: "150px", // Logo height on small screens, 480px - 768px
    logoHeightM: "150px", // Logo height on medium screens, 768px - 1024px
    logoHeightL: "200px", // Logo height on large screens, 1024px - 1440px
    logoHeightXL: "200px", // Logo height on extra large screens, above 1440px
